...
def get_params():
    ...
    args.add_argument("-dim", "--c", default=100, type=int)
    args.add_argument("-bs", "--batch_size", default=32, type=int)#128 1024
    ...
    args.add_argument("-max_neighbor", "--max_neighbor", default=200, type=int)#200 50
    args.add_argument("-lstm_hiddendim", "--lstm_hiddendim", default=700, type=int)#700 200
    ...
    args.add_argument("--g_batch", default=512, type=int)#512 128
    args.add_argument("--eval_batch_size", default=-1, type=int)#-1
